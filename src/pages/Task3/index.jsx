...
function Task3() {
  ...
  const handleThumbnailClick = (record) => {
    // 处理点击缩略图的逻辑，例如导航到详情页面
    navigate(`/task2/results/${record.id}`);
  };
      ...
      return (
        <div className={mainstyles.collectSection}>
          <Input
            ...
            allowClear
          />
      <div className={mainstyles.thumbnailGrid}>
            {filteredData2.map((record) => (
              <div key={record.id} className={mainstyles.thumbnailItem}>
                <PDFPreview2
                ...
                <Button
                  type="primary"
                  className={mainstyles.viewDetailsButton}
